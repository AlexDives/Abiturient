                ...
                <div class="card-body">
                    ...
                    <div class="contact-content">
                        ...
                        <div class="contact-content-about">
                            <h5 class="contact-content-name mb-1"><a href="javascript:void(0)" class="text-body">Агеев А.М.</a></h5>
                            <div class="contact-content-user text-muted small mb-2">ОТДЕЛ АСУВУЗ</div>
                            <div class="small">
                                тел.: <br>
                                16-00
                            </div>
